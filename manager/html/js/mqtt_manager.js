...
function getClientOfflineMsg(clientId, cb) {
    result_callback = cb;
    var xhr = new XMLHttpRequest();
    var url = "http://127.0.0.1:9000/getOfflienMsg?clientId="+clientId;
    xhr.open("GET", url, true);
    xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");
    xhr.onreadystatechange = function(){
...
function getClientSub(clientId, start, limit, cb) {
    result_callback = cb;
    var xhr = new XMLHttpRequest();
    var url = "http://127.0.0.1:9000/getClientSub?start="+start+"&limit="+limit+"&clientId="+clientId;
    xhr.open("GET", url, true);
    xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");
    xhr.onreadystatechange = function(){
